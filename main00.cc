...
int main() {
	...
	//std::ofstream datafile; datafile.open("EventData_ptmin4.csv");
	...
	std::ofstream ptfile; ptfile.open("pThad_Data.csv");
...
*/
		//iint num_D = 0, num_Dbar = 0, num_c = 0, num_cbar = 0, num_pipl = 0, num_pimi = 0, num_Kpl = 0, num_Kmi = 0, num_Ds=0, num_Dsbar=0, num_lambdac=0, num_lambdacbar=0;
		//int D_ind = -1, Dbar_ind = -1;
		int multiplicity = 0;
		//int D_cone_mult = 0, Dbar_cone_mult = 0;
